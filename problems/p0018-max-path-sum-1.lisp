(defpackage #:project-euler/problems/p0018-max-path-sum-1
    (:nicknames #:p0018)
    (:use #:cl #:project-euler/commons)
    (:export #:solve))
(in-package #:project-euler/problems/p0018-max-path-sum-1)

(defparameter *pyramid* (list
(list 75)
(list 95 64)
(list 17 47 82)
(list 18 35 87 10)
...
(defun merge-rows (upper-row lower-sums)
    (mapcar (lambda (val left right) (+ val (max left right)))
        upper-row lower-sums (cdr lower-sums)))
