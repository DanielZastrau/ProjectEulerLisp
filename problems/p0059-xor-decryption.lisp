(defpackage #:project-euler/problems/p0059-xor-decryption
    (:nicknames #:p0059)
    (:use #:cl #:project-euler/commons)
    (:export #:solve))
(in-package #:project-euler/problems/p0059-xor-decryption)
...
(defun main () ()
    (let* ((integers (parse-integers (problem-data "0059_cipher.txt")))
            (len (length integers))
            (start (char-code #\a))
            (end (char-code #\z))
