(defpackage #:project-euler/problems/p0033-digit-cancelling-fractions
    (:nicknames #:p0033)
    (:use #:cl #:project-euler/commons)
    (:export #:solve))
(in-package #:project-euler/problems/p0033-digit-cancelling-fractions)
    ...
    (loop for numerator of-type fixnum from 10 below 100 do
        (loop for denominator of-type fixnum from (+ numerator 1) below 100 do 
            (if (not (and (= 0 (mod numerator 10)) (= 0 (mod denominator 10))))
                (let ((digits-numerator (digits numerator)) (digits-denominator (digits denominator))) (declare (type list digits-numerator digits-denominator))
